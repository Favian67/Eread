...
import 'read_screen_c_t_p_m_model.dart';
export 'read_screen_c_t_p_m_model.dart';

class ReadScreenCTPMWidget extends StatefulWidget {
  const ReadScreenCTPMWidget({Key? key}) : super(key: key);

  @override
  _ReadScreenCTPMWidgetState createState() => _ReadScreenCTPMWidgetState();
}

class _ReadScreenCTPMWidgetState extends State<ReadScreenCTPMWidget> {
  late ReadScreenCTPMModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReadScreenCTPMModel());
  }
