...
import 'read_screen_l_o_l_model.dart';
export 'read_screen_l_o_l_model.dart';

class ReadScreenLOLWidget extends StatefulWidget {
  const ReadScreenLOLWidget({Key? key}) : super(key: key);

  @override
  _ReadScreenLOLWidgetState createState() => _ReadScreenLOLWidgetState();
}

class _ReadScreenLOLWidgetState extends State<ReadScreenLOLWidget> {
  late ReadScreenLOLModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReadScreenLOLModel());
  }
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(60, 7, 0, 0),
                        child: Text(
                          'Love Off Limits',
                          style:
