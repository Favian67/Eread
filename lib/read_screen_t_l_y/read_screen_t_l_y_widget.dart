...
import 'read_screen_t_l_y_model.dart';
export 'read_screen_t_l_y_model.dart';

class ReadScreenTLYWidget extends StatefulWidget {
  const ReadScreenTLYWidget({Key? key}) : super(key: key);

  @override
  _ReadScreenTLYWidgetState createState() => _ReadScreenTLYWidgetState();
}

class _ReadScreenTLYWidgetState extends State<ReadScreenTLYWidget> {
  late ReadScreenTLYModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReadScreenTLYModel());
  }
                    ...
                    children: [
                      Padding(
                        ...
                        child: FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            context.pushNamed('detailScreenTLY');
                          },
                        ),
                      ),
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(70, 7, 0, 0),
                        child: Text(
                          'To Love You',
                          style:
